  ...
  <div class="main">
    ...
    <div class="frame second">
      ...
      <div class="text-group">
        ...
        <p>
          Собрать команду  от&nbsp4  до&nbsp8 человек, зарегистрировать ее на&nbspсайте и&nbspприйти в&nbspуказанные время и&nbspместо на&nbspигру.
        </p>
    ...
    <div class="frame third">
      ...
      <p style="margin-top: 2vh">
        <span style="font-weight: 700; font-size: 20px"
         ...
         от&nbspклассической музыки  до&nbspсовременных сериалов и&nbspкино, от&nbspнауки до&nbspбытовой культуры
      </p>
      <p style="margin-top: 2vh">
