  ...
  <div class="main">
    ...
    <div class="frame second">
      ...
      <div class="text-group">
        ...
        <p>
          это интеллектуально-развлекательная игра в&nbspформате викторины, которая
          станет отличным вариантом для отдыха <br>
          в&nbspхорошей компании.
        </p>
        <h2 class="hcolor">ЧТО НУЖНО СДЕЛАТЬ?</h2>
        <p>
          Собрать команду  от&nbsp4  до&nbsp8 человек, зарегистрировать ее на&nbspсайте <br>
          и&nbspприйти в&nbspуказанные время и&nbspместо на&nbspигру.
        </p>
    ...
    <div class="frame third">
      ...
      <p style="margin-top: 2vh">
        ...
        >
         от&nbspклассической музыки  до&nbspсовременных сериалов и&nbspкино, <br>
         от&nbspнауки  до&nbspбытовой культуры
      </p>
      <p style="margin-top: 2vh">
        <span style="font-weight: 700; font-size: 20px">2 часа</span>
        интеллектуального сражения за звание самых умных игроков вечера и&nbspцелого
        сезона
      </p>
    </div>
  </div>
  ...
  methods: {
    ...
    checkAvailability() {
      ...
      if (this.canRegister === 'closed') {
        ...
        this.bodyText =
          'К сожалению, больше нет мест на&nbspпредстоящую игру. Следите за новостями в&nbspнаших социальных сетях, чтобы точно успеть зарегистрироваться в&nbspследующий раз.'
        this.showModal()
      }
    },
  },
